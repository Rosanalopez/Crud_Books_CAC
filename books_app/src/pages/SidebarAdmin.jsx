...
export const SidebarAdmin=()=>{
    return (
        <div className="flex flex-no-wrap z-50">
            {/* Sidebar starts */}
            {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
            <div className="w-64 h-screen absolute sm:relative bg-gray-800 shadow flex-col justify-between hidden sm:flex">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Show Books</span>
                            </div>
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm  ml-2">Create Books</span>
                            </div>
            ...
            <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
                ...
                <div className="mx-2 h-full">{/* Place your content here */}</div>
                <ShowBooks/>
            </div>
        </div>
    );
